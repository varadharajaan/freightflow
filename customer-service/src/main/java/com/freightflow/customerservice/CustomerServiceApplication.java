...
/**
 * Entry point for the FreightFlow Customer Service.
 *
 * <p>This microservice owns the Customer aggregate and exposes a REST API
 * for managing customer profiles, contracts, and credit operations. It follows
 ...
 *   <li>OAuth2/Keycloak integration for customer identity</li>
 *   <li>Kafka event consumption for cross-service credit operations</li>
...
public class CustomerServiceApplication {
    ...
    /**
     * Starts the Customer Service with embedded Tomcat on the configured port.
     *
