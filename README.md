...
| [Microservices Guide](docs/architecture/MICROSERVICES_GUIDE.md) | Bounded contexts, inter-service events, end-to-end flows |
| [Security Architecture](docs/architecture/SECURITY_ARCHITECTURE.md) | OAuth2/OIDC flow, RBAC matrix, JWT structure, headers |
...
| [Observability](docs/architecture/OBSERVABILITY.md) | Three Pillars — Prometheus, Grafana, Jaeger, alerting |
